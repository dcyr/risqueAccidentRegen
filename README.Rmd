...
The study area is located east of [Lake Mistassini][7], Quebec, Canada, just south of the northern limit of managed forest in Central Quebec. The total area is `r round(totalArea/1000000, 1)` Mha in size, excluding major water bodies. 
...
Targetted fire cycle was simulated with good precision when considering the entire study area (`r cycleGlobal`-year global fire cycle).
