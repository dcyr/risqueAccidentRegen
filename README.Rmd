...
cycleGlobal <- fireRegimeAttrib %>%
    filter(scenario == "baseline" & period == "2011-2040") %>%
...
Le territoire à l'étude est situé à l'est du lac Mistassini, tout juste au sud de la limite nordique des forêts attribuables. Il est d'une superficie totale de `r round(totalArea/1000000, 1)` Mha, excluant les grands cours d'eau. 
